...
/**
 * 解析输入args参数
 * 只解析args部分，不包含java命令中[-options]
 * 如 java -Ds=b -cp  java-coding-test-jar-with-dependencies.jar org.ace.coding.test.TestArgsParse -Da=b -D c=d asdf
 * 解析到a=b,c=d,otherArgs为asdf
 * @author Liangsj
 *
 */
